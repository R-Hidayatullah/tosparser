...
typedef struct
{
    ...
    // followed by:
    //     XSM_WaveletMapping[num_sub_motions]
    //     XSM_WaveletSubMotion[num_sub_motions]
    //     XSM_WaveletChunk[num_chunks]
} XSM_WaveletInfo;
...
typedef struct
{
    ...
    // followed by:
    //     uint8_t compressed_rotation_data[compressed_rotation_num_bytes]
    //     uint8_t compressed_position_data[compressed_position_num_bytes]
